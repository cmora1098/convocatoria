...
@Component({
  selector: 'app-evaluador-panel',
  imports: [SharedModule, NgApexchartsModule],
  templateUrl: './evaluador-panel.component.html',
  styleUrls: ['./evaluador-panel.component.scss']
})
export class EvaluadorPanelComponent {
  // public props
  ...
  cards = [
    ...
    },
    {
      ...
      title: 'Convocatorias En Proceso',
      icon: 'icon-clock',
      // text: 'This Month',
      number: '2',
      // no: '$5,032'
    },
    {
      ...
      title: 'Convocatorias Completadas',
